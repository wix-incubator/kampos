...
prepareVideos([media])
    .then(() => {
        ...
        const shapeMask = effects.shapeMask({radius: 0.2, aspectRatio: width / height, deformation: effects.shapeMask.MAGNIFY});
        ...
        target.addEventListener('pointermove', (e) => {
            ...
            shapeMask.position = {x: offsetX / width, y: (height - offsetY) / height};
        });
    });
