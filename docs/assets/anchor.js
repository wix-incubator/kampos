...
(function (root, factory) {
    ...
    function AnchorJS(options) {
        ...
        function _applyRemainingDefaultOptions(opts) {
            ...
            opts.visible = opts.hasOwnProperty('visible')
                ? opts.visible
                : 'hover'; // Also accepts 'always' & 'touch'
        ...
        this.hasAnchorJSLink = function (el) {
            var hasLeftAnchor =
                    el.firstChild &&
                    (' ' + el.firstChild.className + ' ').indexOf(
                        ' anchorjs-link ',
                    ) > -1,
                hasRightAnchor =
                    el.lastChild &&
                    (' ' + el.lastChild.className + ' ').indexOf(
                        ' anchorjs-link ',
                    ) > -1;
        ...
        function _addBaselineStyles() {
            ...
            firstStyleEl = document.head.querySelector(
